...
public class CircleStatisticalView extends View {
     ...
     * 线条粗细
     */
    private float lineStrokeWidth = dpToPx(0.5F);
    /**
     * 标记文字大小
     */
    private float markTextSize = dpToPx(8);
    /**
     * 标记文字颜色
     */
     ...
     * 数据
     */
    private List<com.android.widget.StatisticalItem> statisticalItems;
    /**
     * 是否使用动画
     */
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        for (int i = 0; i < size; i++) {
            com.android.widget.StatisticalItem item = statisticalItems.get(i);
    ...
    private void userAnimationDraw(Canvas canvas, int size, int drawCount) {
        ...
        if (drawCount == 0) {
            for (int i = 0; i < size; i++) {
                final com.android.widget.StatisticalItem item = statisticalItems.get(i);
    ...
    public List<com.android.widget.StatisticalItem> getStatisticalItems() {
        return statisticalItems;
    }

    public void setStatisticalItems(List<com.android.widget.StatisticalItem> statisticalItems) {
        int size = statisticalItems == null ? 0 : statisticalItems.size();
        float totalPercent = 0;
        List<com.android.widget.StatisticalItem> newItems = new ArrayList<>();
        for (int i = 0; i < size; i++) {
        ...
        for (int i = 0; i < size; i++) {
            com.android.widget.StatisticalItem item = newItems.get(i);
